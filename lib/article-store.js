...
import { articleCoverImage, articleMatchesSearch, articlePopularRank, articleSearchText, articleTags, normalizeArticleSearch } from './article-taxonomy.js';
...
function withArticleMetadata(article) {
  return { ...article, tags: articleTags(article), popularRank: articlePopularRank(article.popularRank), coverImage: articleCoverImage(article) };
}
