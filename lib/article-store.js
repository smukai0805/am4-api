...
import { matchContentAvailability } from './article-content-availability.js';
...
export async function getMatchContentAvailability(fixtureIds) {
  return matchContentAvailability(await loadIndex(), fixtureIds);
}
